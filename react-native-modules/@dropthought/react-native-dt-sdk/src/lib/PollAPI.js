 ...
 */
const POLL_PATH = (programToken, questionId) =>
  `/api/usertoken/${programToken}/question/${questionId}/percentage`;
...
export async function apiPostPollingChoice(
  { programToken, questionId, choice, isOther },
  axiosConfig = {},
  ...
  return fetcher
    .request(POLL_PATH(programToken, questionId), params)
    .then((response) => {
