...
import { apiGetProgramById as _apiGetProgramById, apiGetProgramTokenById as _apiGetProgramTokenById } from './ProgramAPI';
 ...
 * @param {RequestConfig=} requestConfig
 */
export const apiGetProgramTokenById = (param, requestConfig) => _apiGetProgramTokenById(param, requestConfig, sdkFetcher);
 ...
 */
export const apiUploadFileEvent = (file, questionType, requestConfig) => _apiUploadFileEvent(file, questionType, requestConfig, sdkFetcher);

/**
 * @param {PostPollingChoiceFnParams} param
 * @param {AxiosRequestConfig} requestConfig
 */
export const apiPostPollChoice = (param, requestConfig) => _apiPostPollingChoice(param, requestConfig, sdkFetcher);
