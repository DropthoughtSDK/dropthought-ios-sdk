...
export function isRequestTimeoutError(error: any): boolean;
...
export class Fetcher {
     ...
     */
    fetchWithTimeout<T>(url: string, requestConfig: RequestConfig): import("axios").AxiosPromise<T>;
    /**
     ...
     * @returns {import('axios').AxiosPromise<T>}
     */
    public request<T_1>(url: string, requestConfig: RequestConfig): import("axios").AxiosPromise<T_1>;
}
