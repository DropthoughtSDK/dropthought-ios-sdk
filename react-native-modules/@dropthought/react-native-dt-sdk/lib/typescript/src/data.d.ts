export type QuestionType = 'rating' | 'open' | 'multiChoice' | 'singleChoice' | 'nps';
export type QuestionSubType = 'smiley' | 'slider';
export type QuestionBrandType = 'other';
export type QuestionMetaDataType = 'Name' | 'Email' | 'Phone' | 'Number' | 'Date' | 'String';
...
export interface Visibility {
    ...
    themeOption: 'classic' | 'option1' | 'option2' | 'option3' | 'option4' | 'option6' | 'bijliride';
    fontColor: string;
