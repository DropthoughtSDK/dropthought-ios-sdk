...
const ErrorHintScreen = ({
  ...
  const isClassicOrBijliride = themeOption === _reactNativeUi.THEME_OPTION.CLASSIC || themeOption === _reactNativeUi.THEME_OPTION.BIJLIRIDE;
  ...
  }, hideCloseButton || isClassicOrBijliride ? null : header, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: _reactNativeUi.GlobalStyle.flex1
  }, children)));
};
