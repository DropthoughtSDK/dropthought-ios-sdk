...
const surveyWithRules = {
  pageOrder: [
    ...
    '86a829b1-e2ee-4201-a006-ca43d2958e55',
    '6a6d5dca-bc10-4f7a-9d55-4e8ccfc2fbf1',
  ],
  pages: [
    {
    ...
    '366065b9-a495-430e-927a-f4ddc02dc85a': [
      {
        ...
        condition:
          '43c8f71b-4613-4b77-bd99-90cdfacb7f00.nasw.0&&c0ad0634-af48-4903-98c7-01322d323643.answ.0&&6ab17499-9316-49cf-9d70-20827aa20fe3.ansr',
        ruleIndex: 0,
        mode: 'noChange',
      },
      {
        ...
        condition:
          '43c8f71b-4613-4b77-bd99-90cdfacb7f00.answ.3||c0ad0634-af48-4903-98c7-01322d323643.answ.1||6ab17499-9316-49cf-9d70-20827aa20fe3.answ.0',
        ruleIndex: 1,
        mode: 'noChange',
      },
    ],
    ...
    '38923572-2924-45af-bf3f-b2b43b2b3929': [
      {
        ...
        condition:
          'cf82e9de-7140-40d2-b59f-8b43e0dec209.answ.4&&86e3cd04-f81e-4254-a59a-a61641eb9c26.ansr&&64cbf808-95d0-470f-8748-0b9111cdbca5.answ.0',
        ruleIndex: 0,
        mode: 'noChange',
      },
      {
        ...
        toPageId: 'thank-you-page',
        condition:
          'cf82e9de-7140-40d2-b59f-8b43e0dec209.answ.2&&86e3cd04-f81e-4254-a59a-a61641eb9c26.nasr&&64cbf808-95d0-470f-8748-0b9111cdbca5.nasr',
        ruleIndex: 1,
        mode: 'noChange',
      },
    ],
...
describe('original paging behavior when no rules', () => {
  test('survey without rules', () => {
    const surveyWithoutRules = {
      pageOrder: [
        'e528ea34-163b-46a4-a915-92812620171f',
        'a5df0202-4e12-48e2-95a3-d0374ba3e65f',
        '2958a4e7-87d9-4205-9f66-be2e4f72cde8',
        '206b6407-b17b-49f0-9cb9-911747f768f2',
      ],
      pages: [
        {
          ...
          questions: [
            {
              ...
              questionTitle:
                'On a scale of 0-10, how likely are you to recommend NPS to a friend or colleague?',
              scale: '11',
              subType: 'slider',
              type: 'nps',
            },
    ...
    expect(nextPage(0, [], surveyWithoutRules)).toBe(1);
    expect(nextPage(1, [], surveyWithoutRules)).toBe(2);
    expect(nextPage(3, [], surveyWithoutRules)).toBe(-1);
  });

  test('page has no rules defined', () => {
    expect(nextPage(2, [], surveyWithRules)).toBe(3);
    expect(nextPage(3, [], surveyWithRules)).toBe(-1);
  });
});
...
const mockSkipLogicList = [
  ...
  {
    conditionArr: [
      '8ce47319-7ea2-423b-b322-cac316384314',
      'mtch',
      'logic test',
    ],
    filteredFeedback: [
  ...
  {
    conditionArr: [
      '3adb396c-16b8-44ec-b0b3-f260bab36670',
      'nmtch',
      'logic and',
    ],
    filteredFeedback: [
  ...
  {
    conditionArr: [
      '0b54121a-1d5d-4a5e-b7a0-b71a459d1be5',
      'mtch',
      'contains text',
    ],
    filteredFeedback: [
  ...
  {
    conditionArr: [
      '5e3480b2-6e4b-475c-a916-1f0bab87033b',
      '5',
      'mtch',
      'amazon.com',
    ],
  ...
  {
    conditionArr: [
      '918e61b4-4512-4246-8446-4bc2f4fdfffa',
      '0',
      'nmtch',
      'respond promptly',
    ],
...
describe('evaluateCondition skiplogic', () => {
  mockSkipLogicList.forEach((item, index) => {
    ...
    }, ${skipLogicType}, ${filteredFeedback[0].type}`, () => {
      expect(
        evaluateCondition(
          conditionArr,
          filteredFeedback[0].questionId,
