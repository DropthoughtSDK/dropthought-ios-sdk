        ...
        <View style={styles.actionContainer}>
          <View style={styles.actions}>
            <TouchableOpacity style={upperActionStyle} onPress={openFilePicker}>
              <Text style={textStyle}>{i18n.t('file-upload:files')}</Text>
            </TouchableOpacity>
            {Platform.OS === 'ios' ? (
              <TouchableOpacity
              ...
              >
                <Text style={textStyle}>{i18n.t('file-upload:photo')}</Text>
              </TouchableOpacity>
            ) : null}
          </View>
          <TouchableOpacity
    ...
    <ScrollView style={styles.container}>
      ...
      >
        <View style={buttonContainerStyle}>
          ...
          />
          <Text style={fileUploadTextStyle}>
...
export default React.memo(FileQuestion);
