...
var _MultiLineTextInput = require("./MultiLineTextInput/MultiLineTextInput");
...
const DropdownOtherOptionInput = ({
  ...
  const inputTextBorderStyle = isFocused ? {
    ...
    borderWidth: 1,
    backgroundColor: (0, _styles.addOpacityToColor)(themeColor, 0.05)
  } : undefined;
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_MetadataDesc.default, {
    ...
    value: value,
    maxLength: 100,
    keyboardType: (0, _MultiLineTextInput.metadataTypeKeyboard)(question.metaDataType),
    autoCapitalize: (0, _MultiLineTextInput.metadataTypeAutoCapitalize)(question.metaDataType)
...
var _default = exports.default = DropdownOtherOptionInput;
//# sourceMappingURL=DropdownOtherOptionInput.js.map