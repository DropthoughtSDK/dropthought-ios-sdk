...
import { Animated, Easing, I18nManager, Image, PanResponder, View, StyleSheet } from 'react-native'; // styles
...
export class Slider extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      values: updateValues({
        values: normalizeValue(this.props, this.props.value instanceof Animated.Value ? //@ts-ignore
  ...
  componentDidUpdate() {
    const newValues = normalizeValue(this.props, this.props.value instanceof Animated.Value ? //@ts-ignore
    this.props.value.__getValue() : this.props.value);
  ...
  render() {
    ...
    const maxThumbValue = new Animated.Value(maxRawValue); //@ts-ignore
    ...
    const minimumTrackStyle = {
      position: 'absolute',
      left: interpolatedTrackValues.length === 1 ? new Animated.Value(startPositionOnTrack) : Animated.add(minThumbValue, thumbSize.width / 2),
      width: interpolatedTrackValues.length === 1 ? Animated.add(minTrackWidth, thumbSize.width / 2) : Animated.add(Animated.multiply(minThumbValue, -1), maxThumbValue),
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, renderAboveThumbComponent && /*#__PURE__*/React.createElement(View, {
      style: styles.aboveThumbComponentsContainer
      ...
      const value = animatedValue instanceof Animated.Value ? v : animatedValue;
      return /*#__PURE__*/React.createElement(Animated.View, {
        key: `slider-above-thumb-${i}`,
        style: [styles.renderThumbComponent, // eslint-disable-next-line react-native/no-inline-styles
        {
          bottom: 0,
    ...
    })), /*#__PURE__*/React.createElement(View, _extends({}, other, {
      ...
      renderToHardwareTextureAndroid: true,
      style: [styles.track, trackStyle, minimumTrackStyle, propMinimumTrackStyle]
    }), renderTrackMarkComponent && interpolatedTrackMarksValues && interpolatedTrackMarksValues.map((value, i) => /*#__PURE__*/React.createElement(Animated.View, {
      key: `track-mark-${i}`,
      style: [styles.renderThumbComponent, {
        transform: [{
          translateX: value
        }, {
          translateY: 0
    ...
    }, renderTrackMarkComponent(i))), interpolatedThumbValues.map((value, i) => /*#__PURE__*/React.createElement(Animated.View, {
      key: `slider-thumb-${i}`,
      style: [renderThumbComponent ? styles.renderThumbComponent : styles.thumb, renderThumbComponent ? {} : {
    ...
    }, renderThumbComponent ? Array.isArray(renderThumbComponent) ? renderThumbComponent[i]() : renderThumbComponent() : this._renderThumbImage(i))), /*#__PURE__*/React.createElement(View, _extends({
      style: [styles.touchArea, touchOverflowStyle]
    }, this._panResponder.panHandlers), !!debugTouchArea && interpolatedThumbValues.map((value, i) => this._renderDebugThumbTouchRect(value, i)))), renderBelowThumbComponent && /*#__PURE__*/React.createElement(View, {
      style: styles.belowThumbComponentsContainer
    }, interpolatedThumbValues.map((interpolationValue, i) => {
      const animatedValue = values[i] || 0;
      const value = animatedValue instanceof Animated.Value ? //@ts-ignore
...
const CustomSlider = props => {
  return /*#__PURE__*/React.createElement(SliderContainer, props, /*#__PURE__*/React.createElement(Slider, props));
};
