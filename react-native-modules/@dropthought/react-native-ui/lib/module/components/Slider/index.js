...
import { Animated, Easing, I18nManager, Image, PanResponder, View, StyleSheet } from 'react-native';
// styles
...
export class Slider extends PureComponent {
  ...
  render() {
    ...
    const minimumTrackStyle = {
      ...
      // @ts-ignore
      Animated.add(minTrackWidth, thumbSize.width / 2) : Animated.add(Animated.multiply(minThumbValue, -1), maxThumbValue),
